...
public class AdapterEnemyLogo extends BaseAdapter {


    private final ArrayList<Characters> ListMob;

    private final LayoutInflater inflater;
    public AdapterEnemyLogo(Context ct, ArrayList<Characters> liste){
        this.ListMob=liste;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        LogoEnemy.setBackgroundResource(R.drawable.boss2);
