...
public class ListSpell {
    ...
    public ListSpell(){
        ...
        list_s.add(new Spell(true,"Tree of life",9999,3,"Soigne complètement toutes les unités présentes au combat",0,9999));
        ...
        list_s.add(new Spell(true,"Cataclysm",100,3,"Anéanti la moitié des ennemis",3,100));
        ...
        list_s.add(new Spell(true,"Def Up",25,1,"Augmente la défense d'un allié",7,15));
        list_s.add(new Spell(true,"Omni Def Up",15,2,"Augmente la défense de l'équipe",8,50,true));
        ...
        list_s.add(new Spell(true,"Up",20,1,"Augmente les attaques et la défense d'un allié",11,15));
        list_s.add(new Spell(true,"Omni Up",10,2,"Augmente les attaques et la défense de l'équipe",12,50,true));
        ...
        list_s.add(new Spell(false,"Block",0,2,"Prend une posture défensive et bloque tous dégats",25,20));
        ...
        list_s.add(new Spell(false,"Aura of Savior",50,2,"Dégage une aura qui buff toutes les caractéristiques de l'équipe",30,70,true));
    }
}
